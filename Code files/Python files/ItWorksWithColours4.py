...
#         start= "go"
    ...
    if distance is not None:
        ...
        if distance < 100 and sensortwo < 100 and distance_front < 80:
            ...
            speed = 0.73
        if distance > 105 and sensortwo < 100 and 70 <distance_front < 100:
            if direction == "left":
                print("Wall lost! Making sharp left turn...")
                kit.servo[0].angle = 42  # Sharp left
                time.sleep(0.8)
                kit.servo[0].angle = 99
                time.sleep(0.7)
                if sensortwo > 100:
                    kit.servo[0].angle = 120
            if direction == "left" and distance < 30 and sensortwo < 30:
                print("Wall lost! Making sharp left turn...")
                speed = 7
                kit.servo[0].angle = 40  # Sharp left
                time.sleep(0.8)
                kit.servo[0].angle = 99
                time.sleep(0.7)
